...
- [0.1. 领域和子域](#01-领域和子域)
  - [0.1.1. 例子-保险业](#011-例子-保险业)
- [0.2. 核心域、通用域和支撑域](#02-核心域通用域和支撑域)
- [0.3. 界限上下文](#03-界限上下文)
  - [0.3.1. 通用语言](#031-通用语言)
  - [0.3.2. 界限上下文(context)](#032-界限上下文context)
  - [0.3.3. 界限上下文与微服务的关系](#033-界限上下文与微服务的关系)
- [0.4. 实体和值对象](#04-实体和值对象)
  - [0.4.1. 实体](#041-实体)
    - [0.4.1.1. 实体的业务形态](#0411-实体的业务形态)
    - [0.4.1.2. 实体的代码形态](#0412-实体的代码形态)
    - [0.4.1.3. 实体的运行形态](#0413-实体的运行形态)
    - [0.4.1.4. 实体的数据库形态](#0414-实体的数据库形态)
  - [0.4.2. 值对象](#042-值对象)
    - [0.4.2.1. 举例](#0421-举例)
    - [0.4.2.2. 值对象的业务形态](#0422-值对象的业务形态)
    - [0.4.2.3. 值对象的代码形态](#0423-值对象的代码形态)
    - [0.4.2.4. 值对象的运行形态](#0424-值对象的运行形态)
    - [0.4.2.5. 值对象的数据库形态](#0425-值对象的数据库形态)
    - [0.4.2.6. 值对象的优势与局限](#0426-值对象的优势与局限)
  - [0.4.3. 实体与值对象的关系](#043-实体与值对象的关系)
- [0.5. 聚合和聚合根](#05-聚合和聚合根)
  - [0.5.1. 聚合](#051-聚合)
  - [0.5.2. 聚合根](#052-聚合根)
  - [0.5.3. 设计聚合](#053-设计聚合)
    - [0.5.3.1. 聚合的设计原则](#0531-聚合的设计原则)
    - [0.5.3.2. 聚合特点](#0532-聚合特点)
    - [0.5.3.3. 实体的特点](#0533-实体的特点)
    - [0.5.3.4. 值对象的特点](#0534-值对象的特点)
- [0.6. 领域事件](#06-领域事件)
  - [0.6.1. 识别领域事件](#061-识别领域事件)
    - [0.6.1.1. 微服务内的领域事件](#0611-微服务内的领域事件)
    - [0.6.1.2. 微服务之间的领域事件](#0612-微服务之间的领域事件)
  - [0.6.2. 领域事件总体架构](#062-领域事件总体架构)
    - [0.6.2.1. 事件构建和发布](#0621-事件构建和发布)
    - [0.6.2.2. 事件数据持久化](#0622-事件数据持久化)
    - [0.6.2.3. 事件总线](#0623-事件总线)
    - [0.6.2.4. 消息中间件](#0624-消息中间件)
    - [0.6.2.5. 事件接收和处理](#0625-事件接收和处理)
