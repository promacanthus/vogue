...
> docker start 和 docker run命令的区别：`docker run` 命令先是利用镜像创建了一个容器，然后运行这个容器。这个命令非常的方便，并且隐藏了两个命令的细节，但从另一方面来看，这容易让用户产生误解。
...
![image](/images/1525685165106500c2df034.jpeg)
...
![image](/images/15256851693680689a9d194.jpeg)
